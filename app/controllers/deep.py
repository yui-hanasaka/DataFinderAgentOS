...
from app.models.deep import PER_PAGE, DeepRepository, run_deep_collect_task
...
class AdminDeepHandler(AdminBaseHandler):
    ...
    def _handle_collect_single(self) -> None:
        """Start single item deep collection."""
        ...
        IOLoop.current().add_callback(run_deep_collect_task, task_id, [item_id])
